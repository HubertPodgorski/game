...
var snakeHeadArray = ['./build/img/head1.png', './build/img/head2.png', './build/img/head3.png'];
...
function render() {
    ...
    context.drawImage(redApple, apple.x, apple.y, puzzleSize, puzzleSize);

    context.drawImage(snakeHead, player.x, player.y, puzzleSize, puzzleSize);
}
